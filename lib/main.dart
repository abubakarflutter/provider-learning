...
import 'package:providerlearning/switch_example/switch_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (BuildContext context) => SwitchProvider()),
      ],
    child: MaterialApp(
      title: 'Flutter Demo',
      theme: ThemeData(
